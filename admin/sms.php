                    ...
                    <br>
                       <table class="table table-bordered table-hover">
                        ...
                        <?php
                                 ...
                                 $qurey = mysqli_query($connection, "SELECT * FROM massage") or die(mysqli_error($connection)); 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delet_sms.php?id=<?php echo $row['id']; ?>" onclick="return confirm('PAKKA YOU WHAT TO DELET THIS?')" class="label label-important "> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
