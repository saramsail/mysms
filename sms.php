...
<?php require 'partials/header.php' ?>
    ...
    <div id="body">
		...
		<?php 
                ...
                $sms_id = $_GET['id'];
				$getLastessms = mysqli_query($connection, "SELECT * FROM massage WHERE id=$sms_id ORDER BY id DESC LIMIT 1") or die(mysqli_error($connection));
				$viewLastessms = mysqli_fetch_array($getLastessms) 
            ?>
		<article class="expanded">
			...
			<p><?php echo $viewLastessms['content']; ?></p>
		</article>
        </section>
